...
import IDLanding from "./pages/IDLanding";
...
// Redirect billing routes to billing.hanzo.ai
const BillingRedirect = () => {
  window.location.href = 'https://billing.hanzo.ai';
  return null;
};
    ...
    <AccountProvider>
      <Routes>
        ...
        <Route path="/account" element={<AccountLayout />}>
          ...
          {/* Billing routes redirect to billing.hanzo.ai */}
          <Route path="billing" element={<BillingRedirect />} />
          <Route path="billing-plans" element={<BillingRedirect />} />
          <Route path="purchase-credits" element={<BillingRedirect />} />
          <Route path="usage" element={<BillingRedirect />} />
          <Route path="invoices" element={<BillingRedirect />} />
        </Route>
      </Routes>
    </AccountProvider>
  );
