        ...
        >
          <div className="bg-gray-900/30 border border-gray-800 rounded-xl p-6">
            ...
            <div className="flex items-center">
              <div className="h-10 w-10 rounded-full bg-neutral-900/50 flex items-center justify-center text-neutral-300 font-bold">JD</div>
              <div className="ml-3">
          ...
          <div className="bg-gray-900/30 border border-gray-800 rounded-xl p-6">
            ...
            <div className="flex items-center">
              <div className="h-10 w-10 rounded-full bg-neutral-900/50 flex items-center justify-center text-neutral-300 font-bold">MS</div>
              <div className="ml-3">
          ...
          <div className="bg-gray-900/30 border border-gray-800 rounded-xl p-6">
            ...
            <div className="flex items-center">
              <div className="h-10 w-10 rounded-full bg-neutral-900/50 flex items-center justify-center text-neutral-300 font-bold">EJ</div>
              <div className="ml-3">
