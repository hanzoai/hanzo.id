    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-3">
        {aiModels.map((model) => (
          <motion.div
            key={model.id}
            className={`p-3 rounded-lg border ${selectedModel === model.id ? "bg-neutral-900/20 border-neutral-600/40" : "bg-gray-800/40 border-gray-700/40"} hover:bg-gray-800/60 transition-colors cursor-pointer`}
          ...
          >
            <div className="flex items-start justify-between">
              <div>
                <div className="flex items-center">
                  <BrainCircuit className="w-4 h-4 text-neutral-400 mr-2" />
            ...
            {selectedModel === model.id && (
              ...
              >
                ...
                <button className="px-2 py-1.5 bg-neutral-600/30 rounded text-xs text-neutral-200 flex items-center justify-center">
