  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black to-gray-950 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-0 w-2/3 h-1/2 bg-neutral-900/5 rounded-full blur-3xl transform -translate-x-1/4 -translate-y-1/4"></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="bg-gray-900/30 border border-gray-800 rounded-xl p-8 hover:bg-gray-900/40 transition-colors">
            <div className="h-12 w-12 rounded-lg bg-neutral-900/30 flex items-center justify-center mb-6">
        ...
        <motion.div
          ...
          className="mt-20 border border-gray-800 rounded-xl p-6 bg-gradient-to-r from-neutral-900/10 to-neutral-900/10"
        >
