  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[var(--black)] relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute -bottom-64 -right-32 w-96 h-96 bg-neutral-900/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <Quote className="absolute top-6 right-6 h-6 w-6 text-neutral-500/40" />
              <p className="text-neutral-300 mb-8 mt-4">"{testimonial.quote}"</p>
              <div className="flex items-center">
                <div className="h-12 w-12 rounded-full bg-neutral-900/30 overflow-hidden">
                  <img 
            ...
            <div className="md:w-1/3 flex justify-center md:justify-end">
              <div className="flex -space-x-4">
                {[...Array(5)].map((_, i) => (
                  <div 
                    key={i} 
                    className="h-12 w-12 rounded-full bg-neutral-900/50 border-2 border-gray-900 flex items-center justify-center text-neutral-300 text-sm font-medium"
                  >
                    {["JS", "MK", "AL", "TN", "RW"][i]}
                  </div>
                ))}
