...
const UnifiedCapabilities = () => {
  return (
    <section className="py-20 relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-b from-neutral-950/10 to-purple-950/10"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {capabilities.map((capability, index) => (
            <motion.div
              ...
              className="bg-gradient-to-br from-purple-900/20 to-neutral-900/20 border border-purple-500/20 rounded-xl p-6"
            >
