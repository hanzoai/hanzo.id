...
const GlobeContainer: React.FC = () => {
  ...
  return (
    <motion.div
      ref={containerRef}
      className="relative w-full h-[500px] bg-[var(--black)] rounded-lg overflow-hidden mt-8 mb-12 border border-neutral-900/20"
      initial={{ opacity: 0 }}
    ...
    >
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-neutral-900/10 to-cyan-900/10 opacity-50"></div>
      ...
      <div className="absolute inset-0 flex items-center justify-center text-center p-4 pointer-events-none">
        <div className="mt-8 bg-[var(--black)]/30 backdrop-blur-sm rounded-xl p-4 border border-neutral-900/20">
