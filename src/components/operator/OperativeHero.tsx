...
const OperativeHero = () => {
  return (
    <section className="py-32 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 -right-1/4 w-1/2 h-1/2 bg-neutral-500/10 rounded-full blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          >
            <span className="inline-block px-4 py-1 rounded-full bg-neutral-900/30 border border-neutral-500/30 text-neutral-300 text-sm font-medium mb-6">
          ...
          >
            <div className="flex flex-col items-center">
              <div className="h-12 w-12 rounded-lg bg-neutral-900/30 flex items-center justify-center mb-4">
