    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          ...
          >
            <div className="flex items-start mb-6">
              <div className="bg-neutral-900/20 p-3 rounded-full mr-4">
        ...
        >
          <Button 
            size="lg" 
            className="bg-gradient-to-r from-neutral-600 to-indigo-600 hover:from-neutral-700 hover:to-indigo-700 px-8"
          >
