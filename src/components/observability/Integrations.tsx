            ...
            <div className="bg-[var(--black)]/50 rounded-lg p-6 font-mono text-sm">
              ...
              <div>
                ...
                <div className="pl-5 text-[var(--white)]">
                  <span className="text-neutral-400">const</span> response <span className="text-[var(--white)]">=</span> <span className="text-neutral-400">await</span> openai.<span className="text-yellow-300">createChatCompletion</span><span className="text-[var(--white)]">({'{...}'})</span>
