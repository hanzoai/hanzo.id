...
const Security = () => {
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[var(--black)] relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-neutral-900/10 via-transparent to-transparent opacity-70"></div>
            ...
            <div className="relative bg-[var(--black)] rounded-xl border border-gray-800 p-8">
              <div className="space-y-6">
                <div className="flex items-center">
                  <div className="p-2 bg-neutral-900/30 rounded-md mr-4">
