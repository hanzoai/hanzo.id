    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[var(--black)]">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="relative bg-gradient-to-br from-gray-900/50 to-neutral-900/20 border border-gray-800 rounded-xl p-8 overflow-hidden"
        >
              ...
              <div className="text-center">
                ...
                <div className="flex items-end justify-center space-x-2 h-32 mb-4">
                  {[20, 35, 28, 45, 60, 75, 90].map((height, i) => (
                    <div 
                      key={i} 
                      className="bg-gradient-to-t from-neutral-600 to-indigo-500 rounded-t w-6"
                      style={{height: `${height}%`}}
                    ></div>
                  ))}
                </div>
