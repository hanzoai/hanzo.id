        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          >
            <div className="bg-gradient-to-br from-gray-900 to-gray-900/50 rounded-xl border border-gray-800 p-6 h-full">
              <div className="flex justify-center mb-6">
                <div className="p-3 bg-neutral-900/20 rounded-full border border-neutral-800/30">
          ...
          >
            <div className="bg-gradient-to-br from-gray-900 to-gray-900/50 rounded-xl border border-gray-800 p-6 h-full">
                ...
                {certifications.map((cert, index) => (
                  ...
                  >
                    <div className="flex items-center">
                      <div className="mr-3 p-2 bg-neutral-900/30 rounded-full">
              ...
              <div className="mt-8 bg-neutral-900/20 rounded-lg p-5 border border-neutral-900/30">
                <div className="flex">
                  <div className="mr-4 p-2 bg-neutral-900/30 rounded-full">
