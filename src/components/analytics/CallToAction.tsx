...
const CallToAction = () => {
  return (
    <section className="py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-900/30 to-black relative overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-neutral-900/20 via-transparent to-transparent opacity-70"></div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <div className="inline-flex items-center justify-center bg-neutral-900/30 p-3 rounded-full border border-neutral-500/30 text-neutral-400 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <motion.div
              ...
              className="bg-gray-900/20 p-6 rounded-xl border border-gray-800 hover:border-neutral-900/30 transition-colors"
            >
