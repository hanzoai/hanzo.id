    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-[var(--black)] relative">
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-neutral-900/20 to-indigo-900/20 border border-neutral-500/20 rounded-xl p-8 md:p-12"
        >
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  <div className="bg-neutral-500/20 p-1 rounded text-neutral-400 mr-3 mt-0.5">
