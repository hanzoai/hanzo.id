...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 py-32 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-neutral-900/20 via-neutral-900/20 to-black opacity-40"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          <div className="inline-block px-4 py-1 rounded-full bg-neutral-900/30 border border-neutral-500/30 text-neutral-300 text-sm font-medium mb-6">
        ...
        >
          ...
          <Button 
            variant="outline"
            size="lg" 
            className="text-lg px-8 text-[var(--white)] border-neutral-500/30 hover:bg-neutral-900/20"
          >
        ...
        >
          <div className="bg-gray-900/30 border border-neutral-500/20 rounded-xl p-6 text-center">
            <Server className="h-8 w-8 text-neutral-400 mx-auto mb-4" />
          ...
          <div className="bg-gray-900/30 border border-neutral-500/20 rounded-xl p-6 text-center">
            <Zap className="h-8 w-8 text-neutral-400 mx-auto mb-4" />
