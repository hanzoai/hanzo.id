  ...
  return (
    <div className="bg-gray-900 rounded-lg border border-gray-800 p-4 w-full max-w-xl mx-auto">
      <div className="mb-4 h-64 overflow-y-auto bg-gray-950 rounded p-3 border border-gray-800">
        {chatHistory.map((msg, index) => (
          <div 
            ...
            className={`mb-3 p-2 rounded ${
              msg.role === "user" ? "bg-neutral-900/30 ml-12" : "bg-gray-800/50"
            }`}
          >
        ...
        {isLoading && (
          <div className="flex items-center space-x-2 p-2">
            ...
            <div className="w-2 h-2 bg-neutral-500 rounded-full animate-pulse delay-100"></div>
            <div className="w-2 h-2 bg-neutral-500 rounded-full animate-pulse delay-200"></div>
          </div>
        )}
      </div>
      <form onSubmit={handleSubmit} className="flex gap-2">
        ...
        />
        <Button type="submit" disabled={isLoading} className="bg-neutral-600 hover:bg-neutral-500">
          Send
        </Button>
      </form>
          ...
          {products.map((product, index) => (
            ...
            >
              <div className="flex items-center mb-4">
                <div className="h-12 w-12 bg-neutral-900/30 rounded-lg flex items-center justify-center mr-4">
                  {product.icon}
                </div>
