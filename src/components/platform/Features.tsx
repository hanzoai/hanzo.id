          ...
          >
            <div className="w-full lg:w-1/2">
              <div className="flex items-center mb-4">
                <div className="h-12 w-12 rounded-lg flex items-center justify-center bg-neutral-900/20 text-neutral-400 mr-4">
            ...
            <div className="w-full lg:w-1/2 bg-gray-900/50 rounded-xl overflow-hidden border border-gray-800">
              <div className="aspect-video p-8 flex items-center justify-center bg-gradient-to-br from-neutral-900/10 to-neutral-900/10">
                <feature.icon className="h-24 w-24 text-neutral-500/70" />
              </div>
            </div>
          </motion.div>
        ))}
