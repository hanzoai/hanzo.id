...
const RegCFBanner = () => {
  return (
    <div className="sticky top-0 z-50 bg-gradient-to-r from-neutral-900/90 to-neutral-900/90 backdrop-blur-sm py-2 px-4 text-center text-white border-b border-white/10">
