        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-8 md:mb-0">
              ...
              <div className="mt-4 flex flex-wrap gap-4">
                <div className="flex items-center bg-neutral-900/20 border border-neutral-800/50 rounded-md px-3 py-1">
          ...
          >
            ...
            <div className="mt-6 text-center">
              <Button variant="outline" className="bg-neutral-900/30 border-neutral-700/50 hover:bg-neutral-800/50 text-[var(--white)]">
