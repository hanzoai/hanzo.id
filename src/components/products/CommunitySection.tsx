...
const colorMap = {
  discord: "hover:bg-neutral-500/20 hover:border-neutral-500/50",
  github: "hover:bg-neutral-700",
  docs: "hover:bg-neutral-500/20 hover:border-neutral-500/50",
  discussions: "hover:bg-neutral-500/20 hover:border-neutral-500/50",
  twitter: "hover:bg-neutral-700",
  slack: "hover:bg-neutral-600/20 hover:border-neutral-600/50",
};
