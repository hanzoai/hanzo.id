    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[var(--black)]/50">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="h-px w-20 bg-neutral-500 mx-auto"></div>
        </motion.div>
        ...
        >
          <div className="flex justify-center mb-8">
            <HexagonIcon className="h-16 w-16 text-neutral-500 opacity-70" />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-12">
            <a 
              ...
              className="flex items-center justify-between px-8 py-6 bg-gradient-to-r from-neutral-900/30 to-neutral-700/20 hover:from-neutral-800/40 hover:to-neutral-600/30 rounded-lg text-[var(--white)] transition-all group"
            >
