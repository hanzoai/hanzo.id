...
const UseCaseCard: React.FC<UseCaseCardProps> = ({ icon: Icon, title, description, index }) => {
  return (
    ...
    >
      <div className="bg-neutral-900/20 h-10 w-10 rounded-full flex items-center justify-center mb-4">
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black to-neutral-950/10">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center px-3 py-1 rounded-full bg-neutral-900/30 border border-neutral-500/30 mb-6">
