    ...
    >
      ...
      <div className="relative z-10">
        ...
        <Button 
          variant="ghost" 
          size="sm" 
          className="text-neutral-400 hover:text-neutral-300 hover:bg-neutral-900/20 p-2 flex items-center gap-1 transition-all opacity-80 group-hover:opacity-100"
          asChild
        >
          <a href={link}>
