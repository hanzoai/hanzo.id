...
const MigrationStepsSection = () => {
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black/30 to-neutral-900/10">
            ...
            >
              <Card className="bg-gray-900/50 border-gray-800 hover:border-neutral-500/30 transition-all duration-300">
                <CardHeader className="flex flex-row items-start gap-4">
                  <div className="bg-neutral-900/30 rounded-lg p-2 w-12 h-12 flex items-center justify-center flex-shrink-0">
