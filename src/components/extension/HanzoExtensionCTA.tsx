    ...
    <section className="py-24 px-4 sm:px-6 lg:px-8 bg-[var(--black)] relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          ...
          <Button 
            size="lg"
            className="bg-gradient-to-r from-purple-600 to-neutral-500 hover:from-purple-500 hover:to-neutral-400 text-[var(--white)] px-8 py-6 rounded-lg text-lg font-medium shadow-lg hover:shadow-xl transition-all"
          >
