        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="flex flex-col">
              <div className="bg-gradient-to-br from-neutral-900/30 to-neutral-900/30 rounded-xl p-8 border border-neutral-500/20 mb-8">
          ...
          <div className="text-center">
            ...
            <Button variant="outline" className="border-neutral-500 text-[var(--white)] hover:bg-neutral-900/20" size="sm">
