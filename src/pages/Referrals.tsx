  ...
  return (
    <div className="min-h-screen bg-[var(--black)] text-[var(--white)] relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-neutral-900/10 rounded-full blur-3xl transform translate-x-1/4 -translate-y-1/4"></div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  ...
                  <div key={index} className="bg-gray-900/20 border border-gray-800 rounded-xl p-6">
                    <div className="h-16 w-16 rounded-full bg-neutral-900/20 border border-neutral-500/20 flex items-center justify-center mb-4">
                      {step.icon}
                    </div>
