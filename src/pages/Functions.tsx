    ...
    <div className="min-h-screen bg-[var(--black)] text-[var(--white)]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="bg-neutral-500/10 border border-neutral-500/20 rounded-full px-4 py-1 inline-block mb-4">
              <span className="text-neutral-400 text-sm font-medium">Serverless Computing</span>
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-neutral-400 to-cyan-400">
              Hanzo Functions
            </h1>
          ...
          <div className="relative bg-neutral-900/20 border border-neutral-500/20 rounded-xl p-8 overflow-hidden">
            ...
            <pre className="text-sm sm:text-base overflow-x-auto bg-[var(--black)]/50 p-4 rounded-lg border border-neutral-500/30">
              <code className="text-neutral-300">
                <span className="text-neutral-400">export</span> <span className="text-cyan-400">async function</span> <span className="text-neutral-400">handler</span><span className="text-[var(--white)]">(req, res) {'{'}</span>
                <br/>
                ...
                <br/>
                <span className="ml-4 text-neutral-400">return</span> <span className="text-[var(--white)]">Response.json({'{'}</span>
                <br/>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <motion.div 
              ...
              className="bg-neutral-900/20 border border-neutral-500/30 rounded-xl p-6"
            >
              <Terminal className="h-10 w-10 text-neutral-400 mb-4" />
            ...
            <motion.div 
              ...
              className="bg-neutral-900/20 border border-neutral-500/30 rounded-xl p-6"
            >
              <Network className="h-10 w-10 text-neutral-400 mb-4" />
      ...
      <section className="py-20">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-neutral-900/20 to-cyan-900/20 rounded-2xl p-8 md:p-12 border border-neutral-500/30">
