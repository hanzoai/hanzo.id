                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <div className="flex flex-wrap gap-2 mt-4">
                      <Link to={`/solutions/${item.toLowerCase().replace(/\s+/g, '-')}`} className="text-xs flex items-center text-neutral-400 hover:text-neutral-300">
        ...
        {hasMore && (
          ...
          >
            <button
              ...
              className="inline-flex items-center px-6 py-3 rounded-lg border border-neutral-500 text-neutral-400 hover:bg-neutral-500/10 transition-colors"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5">
        <div className="col-span-3 p-8">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-xs px-2 py-1 bg-neutral-900/40 rounded-full text-neutral-300 border border-neutral-500/30">
              {industry}
            </span>
          </div>
        ...
        <div className="col-span-2 bg-gradient-to-br from-neutral-900/40 to-neutral-900/40 flex items-center justify-center p-8">
          <div className="flex flex-col items-center text-center">
            <Award className="h-16 w-16 text-neutral-300 mb-4" />
            <div className="text-4xl font-bold text-[var(--white)] mb-2">200%</div>
            <div className="text-neutral-300">Return on Investment</div>
          </div>
        </div>
      </div>
    </motion.div>
    ...
    return (
      <div className="mb-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div className="bg-gradient-to-br from-neutral-900/30 to-neutral-900/20 rounded-xl border border-neutral-500/20 p-8">
            <div className="mb-6">
              <div className="h-16 w-16 rounded-lg bg-neutral-900/40 flex items-center justify-center mb-4">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button asChild variant="outline" className="border-neutral-500/40 text-neutral-400 hover:bg-neutral-500/10">
  ...
  const renderExpertiseSection = () => (
    <div className="mb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-10">
        <div className="bg-gradient-to-br from-neutral-900/30 to-neutral-900/20 p-8 rounded-xl border border-neutral-500/20">
