  ...
  return (
    <div className="min-h-screen bg-[var(--black)] text-[var(--white)]">
      ...
      <main className="pt-20 pb-20">
        ...
        {/* The Vision Section */}
        <section className="py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black/50 to-neutral-900/10">
          <div className="max-w-4xl mx-auto">
            <motion.div
              initial={{ opacity: 0 }}
            ...
            >
              ...
              <div className="h-1 w-20 bg-neutral-500 mx-auto"></div>
            </motion.div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="p-8 bg-gradient-to-br from-black/80 to-neutral-900/20 backdrop-blur-sm border border-neutral-500/20 rounded-lg">
                ...
                <div className="flex justify-center">
                  <a 
                    href="/platform" 
                    className="px-8 py-3 bg-neutral-600 text-[var(--white)] rounded-md hover:bg-neutral-500 transition-colors"
                  >
